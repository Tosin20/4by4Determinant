namespace _4by4Determinant
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int ans = (matrix[0, 0] * ((matrix[1, 1] * ((matrix[2, 2] * matrix[3, 3]) - (matrix[3, 2] * matrix[2, 3])) - (matrix[1, 2] * ((matrix[2, 1] * matrix[3, 3]) - (matrix[3, 1] * matrix[2, 3])) + (matrix[1, 3] * ((matrix[2, 1] * matrix[3, 2]) - (matrix[3, 1] * matrix[2, 2]))))))) -
